...
<template>
  <nav class="left-0 top-0 z-50 w-full px-4">
    <div
    ...
    <div
      ...
      class="md:hidden mt-2 bg-secondary border-3 border-black shadow-[8px_8px_0_#000000]"
    >
      <RouterLink
        to="/"
      ...
      <a
        href=""
        class="block px-4 py-3 text-white bg-primary hover:bg-opacity-80 font-bold text-center"
        @click="toggleMobileMenu"
        >Contact</a
      >
    </div>
